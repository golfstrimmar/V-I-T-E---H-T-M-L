...
export const CasesInit = () => {
  ...
  [...document.querySelectorAll(".cases")].forEach((cell) => {
    var cases = [...cell.querySelectorAll("._galery-item-js")];
    var CaseTitle = "";
    var CaseContent = "";
    var CaseUrl = "";
    var CaseSrc = "";
  ...
  class Cases {
    constructor(Case) {
      this.Case = Case;
      this.NavButtons = [
        ...this.Case.closest(".galery-nav-js").querySelectorAll(
          "._galery-nav-item-js"
        ),
      ];
      this.sliderBlock =
      ...
      this.plaza = this.Case.closest(".galery-nav-js").nextElementSibling;
      this.dataCases = [...this.plaza.querySelectorAll("._galery-item-js")];
    }
  ...
  document.addEventListener("click", (e) => {
    if (e.target.closest("._galery-nav-item-js")) {
      var tempCase = e.target.closest("._galery-nav-item-js");
